import json
from storage.data import RBTree, SortedLinkedList
from storage.json_encoder import *


class BackupDriver:

	@staticmethod
	def backup_leader_board(leader_board_json_file_path: str, leader_board: SortedLinkedList):
	...
	@staticmethod
	def backup_potential_board(potential_board_json_file_path: str, potential_board: RBTree):
